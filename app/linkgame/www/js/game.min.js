...
function(a) {
    var b = function(a) {
        ...
        b.prototype.onInputDown = function() {
            this.disableInput || (this.game.device.webAudio && tap_music.play(), this.game.add.tween(this.scale).to({
                x: .9,
                y: .9
            },
...
function(a) {
    var b = function() {
        ...
        b.prototype.onMagnetComplete = function(b) {
            this.game.sound.usingWebAudio && new_item_music.play();//.75
...
function(a) {
    var b = function(b) {
        ...
        c.prototype.collectItems = function() {
            var a = this;
            this.game.sound.usingWebAudio && collect_music.play(),
        ...
        c.prototype.showProgressPopup = function(b) {
            ...
            if (c === !1) {
                if (this.itemsProgress[b.itemType] = !0, 12 !== b.itemType) {
                    this.game.sound.usingWebAudio && achieved_music.play();//.66
                    var d = b.title,
        ...
        c.prototype.addItemToChain = function(a) {
            this.game.sound.usingWebAudio && select_music.play(),
            a.highlight(),
            this.chain.push(a),
            this.lastSelectedItem = a;
...
function(a) {
    var b = function(b) {
        ...
        c.prototype.performBuy = function(b) {
            this.game.sound.usingWebAudio && cash_music.play();
